...
declare module "../../Nostr" {
  namespace Nostr {
    ...
    namespace Event {
       ...
       * @example
       * ```
       * let obj: N.Event.WellKnownResponse = {
       *   names: { bob: "af7a7e78a7f7b7" },
       *   relays: { ["af7a7e78a7f7b7"]: ["wss://arelay.com", "wss://another.io"] },
       * };
       * ```
       * which is the equivalent of this json:
       * ```json
       * {
       *   "names": { "bob": "af7a7e78a7f7b7" },
       *   "relays": { "af7a7e78a7f7b7": [
       *     "wss://arelay.com",
       *     "wss://another.io"]
       *   },
       * };
